...
def create_json(txt_file, talkslist, selectslist, endslist):
    """
...
def main():
    ...
    create_json("C-Lang.txt", talkslist, selectslist, endslist)
    with open('plot.json', 'w', encoding="utf-8") as file:
        json.dump([talkslist, selectslist, endslist], file, indent = 2, ensure_ascii=False)
